...
public interface SycoraxListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SycoraxParser#params}.
	 * @param ctx the parse tree
	 */
	void enterParams(@NotNull SycoraxParser.ParamsContext ctx);
	/**
	 * Exit a parse tree produced by {@link SycoraxParser#params}.
	 * @param ctx the parse tree
	 */
	void exitParams(@NotNull SycoraxParser.ParamsContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterFunType(@NotNull SycoraxParser.FunTypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link SycoraxParser#funType}.
	 * @param ctx the parse tree
	 */
	void exitFunType(@NotNull SycoraxParser.FunTypeContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SycoraxParser#content}.
	 * @param ctx the parse tree
	 */
	void enterContent(@NotNull SycoraxParser.ContentContext ctx);
	/**
	 * Exit a parse tree produced by {@link SycoraxParser#content}.
	 * @param ctx the parse tree
	 */
	void exitContent(@NotNull SycoraxParser.ContentContext ctx);
	/**
